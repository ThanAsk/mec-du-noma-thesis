function [] = delay_geom(B,N,gains,weights,Dmin,Dmax)
...
figure;
%Total energy plot
fig2 = plot(Dmin:0.1:Dmax,opt_energies,'--.');
xlabel('Maximum acceptable delay(s)')
ylabel('Weighted Sum of Energies(uJ)')

path='C:\Users\askht\Desktop\autofigs';
saveas(fig2,fullfile(path,['delay_geom' append('w',num2str(w(1)),num2str(w(2)),'D',num2str(Dmin),num2str(Dmax),gains) '.jpeg']));
